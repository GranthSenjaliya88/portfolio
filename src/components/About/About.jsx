...
export default function About() {
  return (
    <section id="about" className="section-shell about-section" aria-labelledby="about-title">
      <SectionHeading index="01" eyebrow="About Granth Senjaliya" title={<><span id="about-title">Curious by nature.</span><br />Practical by choice.</>} description="I learn the fastest when an idea becomes something real—code you can use, hardware you can touch, and systems you can understand." />

      <div className="about-grid">
        <div className="about-copy gsap-reveal">
          <p className="about-lead display-type">I’m Granth Senjaliya, a Computer Science Engineering student who enjoys working where <em>software meets the physical world.</em></p>
        ...
        <div className="about-visual gsap-reveal">
          <div className="about-image-wrap">
            <img className="about-portrait" src={profileWebp} srcSet={`${profileSmall} 479w, ${profileWebp} 767w`} sizes="(min-width: 1024px) 40vw, (min-width: 700px) 620px, calc(100vw - 40px)" alt="Granth Senjaliya in a mountain landscape" loading="lazy" decoding="async" width="767" height="1024" />
